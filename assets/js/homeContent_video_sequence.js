...
function initAllPlayers() {
  ...
  for (let i = 0; i < 4; i++) {
    ...
    playerOptions.id = tempInitialRandomVidIds[i];
    ...
    players[i].on('play', () => {
      console.log(`player${i+1} is playing...`);
    });
    
    players[i].on('pause', () => {
      console.log(`player${i+1} is paused...`);
    });
    
    players[i].on('timeupdate', (filmtime) => {
      if (htmlAdsArePlaying) return;   // ← YOU ALREADY HAVE THIS
...
function doNextMovieLoop() {
  if (htmlAdsArePlaying) return;  // ← THIS IS THE MISSING FIX
                ...
                <div className="row">
                    <div className="font-weight-bolder my-5 standardText2 topOfHome">
                      <div className="topOfHome2 text-center">
                          ...
                          <div id="video_container">
                            ...
                            <div id="video_container2">
                              ...
                              <video id="HomeAd3" class="homeImagesDiv4" controls>
                                  <source type="video/mp4" src="./assets/ads/Pepsi steps on Coke.mp4" />
                              </video>
                        ...
                        <br/>
                        <br/>
                        <ColorBallTxt /> GAMES & ADS' (<CGATxt />) BREAKTHROUGH, NOVEL "<MethodTxt />" OF ADVERTISING AND MARKETING 
                        <br/>
                        WILL MOTIVATE PEOPLE TO LEAVE THEIR HOMES AND VISIT RETAIL STORES WHERE THEY CAN <a href="https://colorballnumbers.com/screens">PLAY</a>  
                        <br/>
                        FIVE <ColorBallTxt /> PICK-3 OR PICK-4 GAMES FOR FREE, EVERY DAY, ON KIOSK E-TABLETS  
                        <br/>
                        ...
                        <div id="myDiv" class="indented"> <font size="+2">What must store-visitors do before <a href="https://colorballnumbers.com/screens">playing</a> the <ColorBallTxt /> Pick-3 or Pick-4 games FOR FREE?</font> </div> 
                        </div> 
                        <br/>
                        <div className="text-left font-weight-bolder my-5 standardText poundSignText" id="text1"> 
                        TO GET A <u>FREE</u> CHANCE TO <a href="https://colorballnumbers.com/screens">PLAY</a> A <ColorBallTxt /> GAME, AND WIN $100.00 OR $1,000.00, A VISITOR MUST TAP THE SCREEN OF AN E-TABLET DURING THE FINAL SIX SECONDS OF A <ColorBallTxt /> VIDEO-AD, AS SHOWN ABOVE.
                        </div> 
                        ...
                        <div id="myDiv" class="indented"> 1..THE <ColorBallTxt />  "<MethodTxt />" WILL ENABLE STOREKEEPERS TO DERIVE SUBSTANTIAL NEW REVENUE BY DISPLAYING THE VIDEO ADS AND CHARGING ADVERTISERS A REASONABLE &quot; FEE PER TAP&quot; (FPT) FOR EACH TIMELY TAP OF AN E-TABLET SCREEN BY EACH VIEWER.</div>  
                        <div id="myDiv" class="indented"> 2..THE CUSTOMER RETENTION (CRV) VALUE OF EACH STORE WILL SOAR BY ENABLING VISITORS TO <a href="https://colorballnumbers.com/screens">PLAY </a> FIVE <ColorBallTxt /> GAMES FOR FREE EVERY DAY.</div> 
                        ...
                        <br/>
                        <div className="text-left font-weight-bolder my-5 standardText poundSignText" id="text1">
                        CHARGING ADVERTISERS BETWEEN $0.20 and $0.40 FOR EACH VERIFIED COMPLETE VIEW OF A <ColorBallTxt />  VIDEO-AD AND &quot;SCREEN-TAP&quot; BY EACH VIEWER IS REASONABLE FOR SEVERAL REASONS: 
                        <div id="myDiv" class="indented"> 1..ADVERTISERS ARE CURRENTLY PAYING ABOUT $0.10 TO $0.30 FOR 30-SECOND VIDEO-ADS THAT HAVE VIEW-THROUGH RATES OF 32%;</div>
                        <div id="myDiv" class="indented"> 2..MANY OF THE GENDER-SPECIFIC <ColorBallTxt /> VIDEO-ADS WILL DESCRIBE PRODUCTS THAT ARE WITHIN ARMS' REACH OF THE IN-STORE VIEWERS;</div>
                        <div id="myDiv" class="indented"> 3..ADVERTISERS WILL NOT BE CHARGED ANYTHING FOR THOUSANDS OF <ColorBallTxt /> VIDEO-ADS THAT ARE VIEWED COMPLETELY AND NOT FOLLOWED BY ANY &quot;ENDING TAPS&quot; OF THE SCREENS.</div>
                        </div>
                        <div className="text-left font-weight-bolder my-5 standardText poundSignText textTap3">
                        ...
                        <div id="myDiv" class="indented"> 1..ADVERTISERS CAN SAY GOODBYE TO THE PATHETIC, CURRENT, 32% "VIEW-THROUGH" RATES OF THEIR VIDEO ADS.  NOW, WITH THEIR VIDEO ADS BEING DISPLAYED VIA THE <ColorBallTxt /> "<MethodTxt />", ADVERTISERS CAN CELEBRATE 100% "VIEW-THROUGH" RATES.</div> 
                        <div id="myDiv" class="indented"> 2..THE ADS' EFFECTIVENESS WILL SKYROCKET. </div>
                        <div id="myDiv" class="indented"> 3..PARTICIPATING ADVERTISERS WILL BE PRAISED FOR USHERING IN THE DAWN OF A NEW ERA OF RETAIL STORE ADVERTISING.</div>
                        </div>
